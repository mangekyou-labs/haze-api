...
- [ ] Hosted funded call after BLS fix: pending the fresh Render deployment and one new test-mode deposit; legacy hosted deposits were created with the pre-fix root arithmetic and are intentionally not used as acceptance fixtures.
