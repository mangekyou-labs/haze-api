...
- [ ] Hosted funded call: blocked pending Render deployment. The last deployed contract reports three deposits, but the documented `42` fixture is not present and no live funded commitment is available for a hosted call.
