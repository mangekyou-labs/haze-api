...
| `ts/stripe-billing.ts`, `web/` | present-unsafe | checkout/dashboard exist; README and product copy still list three SKUs |
...
| B9 | Web purchase, backup gate, Base status, optional SIWE, retired eval UI | present-unsafe | Live SKU $20+$20 / 250 credits; backup before Checkout; no remaining-credit or history | B7 | Web lint/typecheck/build; backup-gate tests | S19, S20, S21, S22 |
