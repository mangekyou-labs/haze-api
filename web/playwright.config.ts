...
export default defineConfig({
  ...
  webServer: {
    ...
    command: `npm run build && AUTH_URL=http://127.0.0.1:${PORT} AUTH_SECRET=base-zk-credits-e2e-test-secret-not-for-production ENABLE_DEV_LOGIN=1 npm run start -- -p ${PORT}`,
